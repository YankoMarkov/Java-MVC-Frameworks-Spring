...
public class VirusController extends BaseController {
    ...
    public ModelAndView allViruses(ModelAndView modelAndView) {
        ...
        modelAndView.addObject("allViruses", virusesAllViewModels);
    ...
    private VirusServiceModel getVirusServiceModel(@Valid @ModelAttribute("virusCreate") VirusCreateBindingModel virusCreate) {
